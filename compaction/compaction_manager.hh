...
private:
    ...
    future<> stop_ongoing_compactions(sstring reason, table* t);
...
public:
    ...
    void propagate_replacement(table*cf, const std::vector<sstables::shared_sstable>& removed, const std::vector<sstables::shared_sstable>& added);
