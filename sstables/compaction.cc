...
public:
    ...
    garbage_collected_sstable_writer(garbage_collected_sstable_writer::data& data) : _data(&data) {}
...
void garbage_collected_sstable_writer::data::on_end_of_stream() {
