...
public:
    ...
    const std::vector<shared_sstable>& gc_sstables() const {
        return _gc_sstables;
    }
...
private:
    ...
    void maybe_replace_exhausted_sstables_by_sst(shared_sstable sst) {
        ...
        if (exhausted != _sstables.end()) {
            ...
            auto unused_gc_sstables = _gc_sstable_writer->consume_unused_gc_sstables();
