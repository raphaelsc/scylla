...
public:
    ...
    virtual compaction_descriptor get_sstables_for_major_compaction(column_family& cf, std::vector<sstables::shared_sstable> candidates) override;
...
compaction_descriptor leveled_compaction_strategy::get_sstables_for_major_compaction(column_family& cf, std::vector<sstables::shared_sstable> candidates) {
    if (candidates.empty()) {
