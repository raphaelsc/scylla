...
private:
    ...
    // Old SSTables are the original sstables that were reshaped and will be removed from maintenance set
...
private:
    ...
    sstables::sstables_mutation_source make_sstables_mutation_source(std::vector<lw_shared_ptr<sstables::sstable_set>> sets) const;
...
public:
    ...
    const sstables::sstable_set& get_maintenance_sstable_set() const;
