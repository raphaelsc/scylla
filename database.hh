...
public:
    ...
    future<> compact_sstables(sstables::compaction_descriptor descriptor, sstables::compaction_info& info);
    ...
    future<> run_offstrategy_compaction(sstables::compaction_info& info);
