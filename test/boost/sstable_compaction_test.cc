...
static std::unique_ptr<table_state> make_table_state_for_test(column_family_for_tests& t, bool has_ongoing_compaction = false) {
    return std::make_unique<table_state_for_test>(t, has_ongoing_compaction);
}
