...
public:
    ...
    // FIXME: make this function return a const ref instead.
    virtual std::vector<range<clustering_key_prefix>> get_all_ranges() = 0;
...
public:
    ...
    std::vector<range<clustering_key_prefix>> get_all_ranges() const;
