...
public:
    virtual ~table_state() {}
    virtual schema_ptr schema() const noexcept = 0;
    // min threshold as defined by table.
    virtual int min_compaction_threshold() const noexcept = 0;
    virtual bool enforce_min_compaction_threshold() const noexcept = 0;
